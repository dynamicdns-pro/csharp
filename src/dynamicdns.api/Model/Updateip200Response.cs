...
namespace dynamicdns.api.Model
{
    ...
    internal partial class Updateip200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Updateip200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Updateip200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Updateip200Response" /> class.
        /// </summary>
        /// <param name="message">message (required).</param>
        public Updateip200Response(string message = default(string))
        {
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for Updateip200Response and cannot be null");
            }
